...
| `station graft` | transplant a hash-pinned declared capability slice into an empty local body and run its fixed check; detects hidden context dependencies without claiming a security sandbox |
